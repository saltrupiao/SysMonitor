...
def insert():
    ...
    #sql = "INSERT INTO `client` (`cli_hostname`,`cli_mem_total`, `cli_mem_remaining`, `cli_mem_pctg`, `cli_disk_avail`, `cli_disk_used`) VALUES (%s, %s)"
    #cursor.execute(sql, (hostName, memTot, memRemain, memPercent, dskAvail, dskUsed,))
    try:
